                  ...
                  >
                    ...
                    <TableCell className="text-right">
                      <div className="font-semibold text-lg flex items-center justify-end gap-2">
                        {emp.vacationBalanceDays >= 30 && !emp.nextVacationStart && !emp.isOnVacation && (
                          <div className="w-2 h-2 rounded-full bg-red-500" title="Férias Vencidas" />
                        )}
                    ...
                    <TableCell className="text-right">
                      ...
                      ) : emp.daysUntilNextVacation === 0 && emp.vacationBalanceDays >= 30 ? (
